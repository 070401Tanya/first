...
function SelfDeclaration() {
	...
	return (
		<div className="centered-box" style={{ textAlign: 'justify' }}>
			<Card className="cardstyle" style={{ width: '60rem' }}>
				<Card.Body>
					<p style={{ textAlign: 'center' }} className='consumer'> <strong> Self Declaration Form</strong></p>
					<div style={{ padding: '10px', border: '3px solid rgb(230, 230, 230)', margin: '150x', borderRadius: '5px' }}>
						<div className="col-md-12">
							<div className="card-body overflow-auto" style={{ maxHeight: '350px' }}>

								<p>
									I, <a id="dec_individual_name" className="dec_individual_name" style={{ fontweight: 'bold' }}>____</a> Son/Daughter/Wife of <a id="dec_individual_father_name" className="dec_individual_father_name" style={{ fontweight: 'bold' }}>_____</a>
									Resident of <a id="dec_individual_address" className="dec_individual_address" style={{ fontweight: 'bold' }}>____</a> (hereinafter
								...
								Or
								<p>
									The <a id="dec_firm_name" className="dec_firm_name" style={{ fontweight: 'bold' }}>___</a>, a company incorporated under the provisions of the Companies Act, 1956 or as amended,
									having its registered office at <a id="dec_firm_address" className="dec_firm_address" style={{ fontweight: 'bold' }}>___</a> (hereinafter referred to as "Applicant", which
									...
									representative Mr. <a id="dec_authorized_signatory" className="dec_authorized_signatory" style={{ fontweight: 'bold' }}>___</a> do hereby swear and declare as under:
								</p>
								Or
								<p>
									A Sole proprietorship/ a partnership firm having its office at <a id="address2" className="dec_firm_address" style={{ fontweight: 'bold' }}>___</a> (hereinafter referred to as
									the applicant which unless the context otherwise provides includes its successors and assigns), through Mr. <a id="authorizedSignature2" className="dec_authorized_signatory" style={{ fontweight: 'bold' }}>___</a> , who is a partner or an authorized representative do hereby swear and declare as under:
								</p>
								<p>
									THAT the Applicant is a lawful occupant of the premises at <a id="address3" className="dec_connection_address" style={{ fontweight: 'bold' }}>___</a>(hereinafter the "Premises").
								</p>
								...
								<p>
									...
									</p><p> Provided that in case of Government quarters/ offices, the certificate issued by the designated officer
										of
								...
								<p>
									I, <a id="fullName" className="dec_applicant_name" style={{ fontweight: 'bold' }}>___</a> son/daughter/Authorized representative of <a id="fatherName2" className="dec_firm_or_father_name" style={{ fontweight: 'bold' }}>___</a> resident of <a id="fullAddress" className="dec_applicant_address" style={{ fontweight: 'bold' }}></a> Connection applied address <a id="fullAddress1" className="dec_connection_address" style={{ fontweight: 'bold' }}>
								...
								</p><p>A. Residential Building:For the dwelling units which are above the heights of 15 meters without stilt parking and which are above the height of 17.5 meters with stilt parking of the building.</p>

								<p>B. Other than Residential Building:

								</p><p>· Hotels and Guest Houses having height more than 12 meters</p>
								...
								<table className="center" style={{ width: '80%' }}>
									<tbody>
										<tr style={{ backgroundColor: 'black', color: 'white', textAlign: 'center' }}>
											<th colspan="3" style={{ textAlign: 'center' }}>HDPE Pipe Sizes for laying of Underground Cables*</th>
										</tr>
								...
								<p></p>
								<p>
									I, <a id="detail1" className="dec_applicant_name" style={{ fontweight: 'bold' }}></a> Son/Daughter/Wife of <a id="detail2" className="dec_applicant_father_name" style={{ fontweight: 'bold' }}>____</a>
									Resident of <a id="detail3" className="dec_applicant_address" style={{ fontweight: 'bold' }}></a> (hereinafter referred to as "Applicant", which term shall mean and include
									executors, administrators, heirs, successors and assigns), do hereby swear and declare as under:
								</p>

								<p>
									A. That the Applicant / deponent is owner / occupant of the premises bearing no. , situated at <a id="detail4" className="dec_connection_address" style={{ fontweight: 'bold' }}>
									</a>
								</p>

								<p>
									B. That I have applied for <a id="declarationTariff" style={{ fontweight: 'bold' }}>-Select-</a>- new connection (Domestic/ Non-domestic/ Industrial at the
					...
					<Form>
						<Form.Check
							...
							label={<span style={{ fontSize: '14px' }}>
								Verified at New Delhi that the content of the above self-declaration are true and correct to the best of my knowledge of behalf.*
							</span>}
							checked={isChecked}
							onChange={handleCheckboxChange}
						/>
					</Form>
					<p style={{ fontSize: '14px', color: 'red', marginLeft: '25px' }}>Note: Please read and accept self declaration/undertaking and scroll down to last to activate check box</p>
				</Card.Body>
			</Card>
		</div>
	);
